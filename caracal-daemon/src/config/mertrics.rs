...
impl MetricsConfig {
    ...
    #[inline]
    pub const fn default_host() -> IpAddr { caracal_base::DEFAULT_METRICS_HOST }

    #[inline]
    pub const fn default_port() -> u16 { caracal_base::DEFAULT_METRICS_PORT }
}
...
impl From<MetricsConfig> for caracal_server::config::MetricsConfig {
