...
pub struct GrpcConfig {
    ...
    #[serde(default = "caracal_base::config::default_unix_domain_socket")]
...
impl GrpcConfig {
    ...
    #[inline]
    pub const fn default_host() -> IpAddr { caracal_base::DEFAULT_GRPC_HOST }

    #[inline]
    pub const fn default_port() -> u16 { caracal_base::DEFAULT_GRPC_PORT }
...
impl Default for GrpcConfig {
    fn default() -> Self {
        Self {
            ...
            local_socket: caracal_base::config::default_unix_domain_socket(),
