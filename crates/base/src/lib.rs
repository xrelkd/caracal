...
pub const DBUS_SERVICE_NAME: &str = "org.caracal.caracal";
pub const DBUS_OBJECT_PATH_PREFIX: &str = "/org/caracal/caracal";
pub const DBUS_SYSTEM_OBJECT_PATH: &str = "/org/caracal/caracal/system";
pub const DBUS_MANAGER_OBJECT_PATH: &str = "/org/caracal/caracal/manager";
...
pub const NOTIFICATION_SUMMARY: &str = "Caracal - Download Manager";

pub const DAEMON_PROGRAM_NAME: &str = "caracal-daemon";
pub const DAEMON_CONFIG_NAME: &str = "caracal-daemon.toml";

pub const CTL_PROGRAM_NAME: &str = "caracalctl";
pub const CTL_CONFIG_NAME: &str = "caracalctl.toml";

pub const STANDALONE_PROGRAM_NAME: &str = "caracal";
pub const STANDALONE_CONFIG_NAME: &str = "caracal.toml";

pub const DEFAULT_GRPC_PORT: u16 = 37045;
pub const DEFAULT_GRPC_HOST: IpAddr = IpAddr::V4(Ipv4Addr::LOCALHOST);

pub const DEFAULT_WEBUI_PORT: u16 = 37046;
pub const DEFAULT_WEBUI_HOST: IpAddr = IpAddr::V4(Ipv4Addr::LOCALHOST);

pub const DEFAULT_METRICS_PORT: u16 = 37047;
